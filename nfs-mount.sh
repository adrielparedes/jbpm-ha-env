...
sudo mount -o rw -t nfs 127.0.0.1:/data/dev/jboss/jbpm-ha-env/nfs/shared ./nfs/niogit1
sudo mount -o rw -t nfs 127.0.0.1:/data/dev/jboss/jbpm-ha-env/nfs/shared ./nfs/niogit2